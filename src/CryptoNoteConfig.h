...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x2d6f;
...
const char     CRYPTONOTE_NAME[]                             = "huecoin";
...
const int      P2P_DEFAULT_PORT                              = 64553;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 65553;
